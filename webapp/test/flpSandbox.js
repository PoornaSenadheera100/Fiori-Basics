		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Customer App",
									"targetURL": "#customerappfreestylecustomerappfreestyle-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"customerappfreestylecustomerappfreestyle-display": {
								"semanticObject": "customerappfreestylecustomerappfreestyle",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=customerappfreestyle.customerappfreestyle",
									"url": sap.ui.require.toUrl("customerappfreestyle/customerappfreestyle")
								}
							}
						}
					}
